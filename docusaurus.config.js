...
module.exports = {
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        {to: 'docs/ais_bramka_index', label: 'Bramki', position: 'left'},
        {to: 'docs/ais_app_index', label: 'Aplikacje', position: 'left'},
        {to: 'docs/ais_app_player', label: 'Integracje', position: 'left'},
        {to: 'docs/ais_zigbee_index', label: 'Urządzenia', position: 'left'},
        {to: 'docs/ais_dom_pro_index', label: 'Oferta PRO', position: 'left'},
