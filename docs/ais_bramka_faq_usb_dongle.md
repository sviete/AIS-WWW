...
Na urządzeniu jest pełny dostęp z poziomu root-a i [środowisko Linux](/docs/en/ais_gate_faq_package_compile.html#środowisko-linux-a-ktore-mamy-na-urządzeniu), opisujemy jak skompilować pakiet i dostarczyć do naszego repozytorium apt [w FAQ](/docs/en/ais_gate_faq_package_compile.html#kompilacja-pakietu)
