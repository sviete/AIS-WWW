      ...
      $.ajax({
        ...
        success: function() {
          ...
          $('#success > .alert-success')
            .append("<strong>OK, Thank you " + email + "!</strong></br> We'll let you know about starting a campaign.");
          $('#success > .alert-success')
            .append('</div>');
        ...
        error: function() {
          ...
          $('#success > .alert-danger').html("<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;")
            .append("</button>");
          $('#success > .alert-danger').append($("<strong>").text("Sorry, the email server is not responding.</br>Please try again later!"));
